...
<div class="container-fluid {{Route::is('create-ticket','register','client.user.update.show','client.show.ticket','admin.panel','client.show.ticket','admin.show.users','create-ticket','admin.show.tickets','admin.active.tickets') ? '' : 'position-absolute'}} w-100 bottom-0">
